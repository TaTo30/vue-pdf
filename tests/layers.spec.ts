...
describe("Text Layer", () => {
  ...
  test("Visibility", async () => {
    ...
    await waitUntil(() => wrapper.emitted("textLoaded"));
  ...
  test("Highlight", async () => {
    ...
    expect(wrapper).toBeTruthy();
    await waitUntil(() => wrapper.emitted("highlight"));
    ...
    await waitUntil(() => wrapper.emitted("highlight")?.length === 2);
    expect(
    ...
    await waitUntil(() => wrapper.emitted("highlight")?.length === 3);
    expect(
    ...
    await waitUntil(() => wrapper.emitted("highlight")?.length === 4);
    expect(
...
describe("Annotation Layer", () => {
  ...
  test("Visibility", async () => {
    ...
    await waitUntil(() => wrapper.emitted("annotationLoaded"));
  ...
  test("Forms Fields", async () => {
    ...
    await waitUntil(() => wrapper.emitted("annotation"));
    ...
    await waitUntil(() => wrapper.emitted("annotation")?.length === 2);
    ...
    await waitUntil(() => wrapper.emitted("annotation")?.length === 3);
    ...
    await waitUntil(() => wrapper.emitted("annotation")?.length === 4);
...
describe("XFA Layer", () => {
  ...
  test("Visibility", async () => {
    ...
    await waitUntil(() => wrapper.emitted("xfaLoaded"));
